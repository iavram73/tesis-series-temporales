...
# Trabajo con las series ya generadas en txt
series_arima212 <- read.csv("data/muestra_arima212_0.7_0.2_0.8_0.4.csv") # 1000 series
# saco los primeros 100 datos de cada serie.
series_arima212 <- series_arima212[,101:600]
dim(series_arima212) # 1000  500
View(series_arima212)

# plot(as.numeric(series_arima212[10,]))
