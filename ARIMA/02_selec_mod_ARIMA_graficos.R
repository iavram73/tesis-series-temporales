...
# Leo los datos guardados para ARIMA (2,1,2): 
...
# Veo cuantas veces elije cada modelo.

table(selec_modelo_arima212_500$ID_bic)
table(selec_modelo_arima212_500$ID_aic)

table(selec_modelo_arima212_200$ID_bic)
table(selec_modelo_arima212_200$ID_aic)

table(selec_modelo_arima212_50$ID_bic)
table(selec_modelo_arima212_50$ID_aic)



# Hago los graficos para ARMA (2,2)


# Hago los graficos (con semilla 123 en la funcion donde genero los datos())
...
g7 <- selec_modelo_arima212_50 %>% ggplot(aes(ID_aic)) + 
  ...
  geom_bar(data=subset(selec_modelo_arima212_50, ID_aic=="(2,2)"), fill="#9FCAE6", colour="#2A5783", size=0.5) +
...
g8 <- selec_modelo_arima212_200 %>% ggplot(aes(ID_aic)) + 
  geom_bar(colour="black") +
  geom_bar(data=subset(selec_modelo_arima212_200, ID_aic=="(2,2)"), fill="#B3E0A6", colour="#256D3D", size=0.5) +
...
g9 <- selec_modelo_arima212_200 %>% ggplot(aes(ID_aic)) + 
  geom_bar(colour="black") +
  geom_bar(data=subset(selec_modelo_arima212_200, ID_aic=="(2,2)"), fill="#FE8F7F", colour="#BD1100", size=0.5) +
...
g10 <- selec_modelo_arima212_50 %>% ggplot(aes(ID_bic)) + 
  geom_bar(colour="black") +
  geom_bar(data=subset(selec_modelo_arima212_50, ID_bic=="(2,2)"), fill="#9FCAE6", colour="#2A5783", size=0.5) +
...
g11 <- selec_modelo_arima212_200 %>% ggplot(aes(ID_bic)) + 
  geom_bar(colour="black") +
  geom_bar(data=subset(selec_modelo_arima212_200, ID_bic=="(2,2)"), fill="#B3E0A6", colour="#256D3D", size=0.5) +
  geom_bar(data = puntos, aes(opciones), colour = "black", size = 0.5)+
...
g12 <- selec_modelo_arima212_500 %>% ggplot(aes(ID_bic)) + 
  geom_bar(colour="black") +
  geom_bar(data=subset(selec_modelo_arima212_500, ID_bic=="(2,2)"), fill="#FE8F7F", colour="#BD1100", size=0.5) +
  geom_bar(data = puntos_d, aes(opciones), colour = "black", size = 0.5)+
